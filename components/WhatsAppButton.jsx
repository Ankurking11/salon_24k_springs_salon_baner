...
export default function WhatsAppButton() {
  ...
  return (
    ...
    >
      {/* Tooltip */}
      <div
        className={`bg-gray-900 text-white text-sm font-medium px-4 py-2 rounded-full shadow-lg transition-all duration-300 whitespace-nowrap ${
      ...
      <div className="relative w-14 h-14 bg-[#25D366] rounded-full flex items-center justify-center shadow-lg hover:shadow-xl hover:scale-110 transition-all duration-300 cursor-pointer">
        ...
        <div className="absolute inset-0 bg-[#25D366] rounded-full animate-ping opacity-20 animation-delay-300" />
